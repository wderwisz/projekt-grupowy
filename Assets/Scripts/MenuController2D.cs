...
public class MenuController2D : MonoBehaviour
{
    ...
    [SerializeField] private Button ereaserButton;
    ...
    public void DeleteDrawings() //funkcja do usuwania szlaku
    {
        Debug.Log("Usunieto");
    ...
    {
        buttonText.text = isStateX ? "Œcieraj szlak" : "Zakoñcz œcieranie";
    }

    public bool getEareserState()
    {
        return isStateX;
    }
}
